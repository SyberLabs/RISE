...
export class Settings {
        ...
        <div class="settings-content" id="settings-content">
          ...
          <section class="settings-section settings-about" aria-labelledby="about-heading">
            ...
            <div class="about-content text-fog">
              <p class="about-version font-mono">R.I.S.E. v0.1.0</p>
    ...
    exportData() {
        try {
            ...
            // Also export session history if available
            const history = localStorage.getItem('rise-history');
            if (history) {
    ...
    clearHistory() {
        const confirm = window.confirm('Clear all session history? This cannot be undone.');
        if (!confirm) return;

        try {
            localStorage.removeItem('rise-history');
